...
local getcustomassets = {
	['tumbavape/assets/old/barlogo.png'] = 'rbxasset://barlogo.png',
	['tumbavape/assets/old/blatanticon.png'] = 'rbxasset://blatanticon.png',
	['tumbavape/assets/old/checkbox.png'] = 'rbxasset://checkbox.png',
	['tumbavape/assets/old/combaticon.png'] = 'rbxasset://combaticon.png',
	['tumbavape/assets/old/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['tumbavape/assets/old/guiicon.png'] = 'rbxasset://guiicon.png',
	['tumbavape/assets/old/info.png'] = 'rbxasset://info.png',
	['tumbavape/assets/old/pin.png'] = 'rbxasset://pin.png',
	['tumbavape/assets/old/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['tumbavape/assets/old/rendericon.png'] = 'rbxasset://rendericon.png',
	['tumbavape/assets/old/search.png'] = 'rbxasset://search.png',
	['tumbavape/assets/old/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['tumbavape/assets/old/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['tumbavape/assets/old/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['tumbavape/assets/old/textv4.png'] = 'rbxasset://textv4.png',
	['tumbavape/assets/old/texttumbahub.png'] = 'rbxasset://texttumbahub.png',
	['tumbavape/assets/old/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['tumbavape/assets/old/tumbahub.png'] = 'rbxassetid://14373395239',
	['tumbavape/assets/old/worldicon.png'] = 'rbxasset://worldicon.png'
}
	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('tumbavape/assets/old/checkbox.png')
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('tumbavape/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('tumbavape/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('tumbavape/assets/old/search.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('tumbavape/assets/old/pin.png')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('tumbavape/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('tumbavape/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('tumbavape/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('tumbavape/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('tumbavape/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('tumbavape/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('tumbavape/assets/old/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('tumbavape/assets/old/worldicon.png')
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('tumbavape/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('tumbavape/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('tumbavape/assets/old/profilesicon.png'),
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('tumbavape/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
local Tumba VapeLogo = Instance.new('ImageLabel')
Tumba VapeLogo.Name = 'Logo'
Tumba VapeLogo.Size = UDim2.fromOffset(96, 26)
Tumba VapeLogo.Position = UDim2.new(1, -142, 0, 3)
Tumba VapeLogo.BackgroundTransparency = 1
Tumba VapeLogo.BorderSizePixel = 0
Tumba VapeLogo.Visible = true
Tumba VapeLogo.BackgroundColor3 = Color3.new()
Tumba VapeLogo.Image = getcustomasset('tumbavape/assets/old/texttumbahub.png')
...
Tumba VapeLogoV4.Size = UDim2.fromOffset(43, 30)
Tumba VapeLogoV4.Position = UDim2.new(1, 1, 0, -2)
Tumba VapeLogoV4.BackgroundColor3 = Color3.new()
Tumba VapeLogoV4.BackgroundTransparency = 1
Tumba VapeLogoV4.BorderSizePixel = 0
Tumba VapeLogoV4.Image = getcustomasset('tumbavape/assets/old/textv4.png')
Tumba VapeLogoV4.Parent = Tumba VapeLogo
local Tumba VapeLogoShadow = Tumba VapeLogo:Clone()
Tumba VapeLogoShadow.Position = UDim2.fromOffset(1, 1)
Tumba VapeLogoShadow.ZIndex = 0
Tumba VapeLogoShadow.Visible = true
Tumba VapeLogoShadow.ImageColor3 = Color3.new()
Tumba VapeLogoShadow.ImageTransparency = 0.65
Tumba VapeLogoShadow.Parent = Tumba VapeLogo
Tumba VapeLogoShadow.Logo2.ZIndex = 0
Tumba VapeLogoShadow.Logo2.ImageColor3 = Color3.new()
Tumba VapeLogoShadow.Logo2.ImageTransparency = 0.65
...
function mainapi:UpdateTextGUI(afterload)
	...
	if textgui.Button.Enabled then
		...
		Tumba VapeLogo.Position = right and UDim2.new(1 / Tumba VapeTextScale.Scale, -141, 0, 4) or UDim2.fromOffset(5, 4)
		...
		Tumba VapeLabelHolder.Position = UDim2.fromOffset(4, 4 + (Tumba VapeLogo.Visible and Tumba VapeLogo.Size.Y.Offset or 0))
...
function mainapi:UpdateGUI(hue, sat, val, default)
	...
	if textgui.Button.Enabled then
		...
		Tumba VapeLogoGradient2.Color = mainapi.GUIColor.Rainbow and Tumba VapeLogoGradient.Color or ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.new(1, 1, 1)),
			ColorSequenceKeypoint.new(1, Color3.new(1, 1, 1))
		})
		for i, v in Tumba VapeLabels do
			v.Text.TextColor3 = customcolor or (mainapi.GUIColor.Rainbow and Color3.fromHSV(mainapi:Color((hue - ((i + 2) * 0.025)) % 1)) or Tumba VapeLogoGradient.Color.Keypoints[2].Value)
		end
	end
